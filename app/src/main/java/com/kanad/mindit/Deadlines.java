...
public class Deadlines extends Fragment {
    ...
    ArrayList<RequestsStatusModel> loadsArrayList;
    TodaysTaskAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_available_work, container, false);
        ...
        adapter = new TodaysTaskAdapter(getContext(),loadsArrayList);
        ...
        DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference("Deadlines").child(GoogleSignIn.getLastSignedInAccount(getContext()).getId());
        databaseReference1.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    loadsArrayList.add(dataSnapshot.getValue(RequestsStatusModel.class));
                }
                availableLoadsRecView.setVisibility(View.VISIBLE);
                progressLayout.setVisibility(View.GONE);
                pdt.setVisibility(View.GONE);
                total.setText("Total Deadlines: "+loadsArrayList.size());
            }
