...
public class TodaysTask extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference("AllTasks").child(GoogleSignIn.getLastSignedInAccount(getContext()).getId());
        databaseReference1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                total.setText("Total Tasks: "+loadsArrayList.size());
            }
